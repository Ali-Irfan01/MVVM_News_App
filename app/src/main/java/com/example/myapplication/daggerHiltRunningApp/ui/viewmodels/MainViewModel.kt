package com.example.myapplication.daggerHiltRunningApp.ui.viewmodels
...
import com.example.myapplication.daggerHiltRunningApp.repositories.MainRepository
...
class MainViewModel @Inject constructor(
    ...
    fun sorRuns(sortType: SortType) = when(sortType)    {
